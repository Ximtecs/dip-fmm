...
TaylorJet::TaylorJet(const MultiIndexSet& basis) : basis_(&basis), c_(basis.size(), 0.0) {}
...
TaylorJet TaylorJet::coordinate(const MultiIndexSet& basis, int axis, double c) {
